...
#import "CLHistoryCancelRemittance.h"

@interface CLHistoryCancelRemittance ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic,strong)NSArray *mData;
@end

@implementation CLHistoryCancelRemittance
