...
#define kEncryptionKey  @"ABCEDEFGHIJKLMN"//加密密钥

@implementation WKEncryption
+ (NSData*)encrypt:(NSString*)encryptionString
{
    NSData *plain = [encryptionString dataUsingEncoding:NSUTF8StringEncoding];
    
    NSData *cipher = [plain AES256EncryptWithKey:kEncryptionKey];
...
{
    NSData *plain = [decryptionData AES256DecryptWithKey:kEncryptionKey];
