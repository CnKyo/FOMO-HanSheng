...
- (void)setStatus:(NSString *)string {
    ...
    CGFloat hudWidth = 190;
    CGFloat hudHeight = 190;
    ...
    CGRect mStringFrame = self.stringLabel.frame;
    CGRect mImgFrame = self.imageView.frame;
    mStringFrame.origin.y = mImgFrame.origin.y+mImgFrame.size.height+25;
    mStringFrame.origin.x = 25;
    mStringFrame.size.width = hudWidth-25*2;
    mStringFrame.size.height = 40;
}
...
- (UILabel *)stringLabel {
    if (stringLabel == nil) {
        stringLabel = [[UILabel alloc] initWithFrame:CGRectMake(5, 125, 180, 40)];
...
- (UIImageView *)imageView {
    if (imageView == nil) {
        imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 84, 84)];
